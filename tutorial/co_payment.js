...
window.addEventListener("load", function(){
   ...
   window.addEventListener("load", function(){
      ...
      document.getElementById("cardName").onclick = validateName;
      document.getElementById("cardNumber").onclick = validateNumber;
      document.getElementById("expMonth").onclick = validateMonth;
      document.getElementById("expYear").onclick = validateYear;
   });
   ...
   function validateMonth(){
      ...
      if(cardMonth.selectedIndex === 0){
         cardMonth.setCustomValidity("Selected the expiration month");
      }
      else{
   ...
   function validateYear(){
      ...
      if(cardYear.selectedIndex === 0){
         cardYear.setCustomValidity("Selected the expiration year");
      }
      else{
...
function luhn(idNum){
   ...
   for(var i = idNum.length - 2; 1 >= 0; i-=2){
